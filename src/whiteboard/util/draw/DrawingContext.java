 ...
 * information about the style with which the elements are drawn. Diagram
...
public interface DrawingContext {
  ...
  /**
   * Draws the specified oral with the given fill color and stroke color.
   * @param x
   * @param y
   * @param width
   * @param height
   ...
   * @param fillColor
   */
  void drawOral(double x, double y, double width, double height,
		    Color strokeColor, Color fillColor);
  ...
  void drawUsercase(double x, double y, double width, double height);
}
