 ...
 */
package whiteboard.view.diagram;
...
import whiteboard.umldraw.structure.Association;
import whiteboard.umldraw.structure.ClassElement;
import whiteboard.umldraw.structure.StructureDiagram;
import whiteboard.util.draw.Connection;
import whiteboard.util.draw.DiagramElement;
import whiteboard.util.draw.DiagramOperations;
import whiteboard.util.draw.DrawingContext;
import whiteboard.util.draw.DrawingContextImpl;
import whiteboard.util.draw.Label;
import whiteboard.util.draw.MultiLineLabel;
import whiteboard.util.draw.Node;
import whiteboard.util.draw.NodeChangeListener;
import whiteboard.util.draw.RectilinearConnection;
import whiteboard.util.draw.Scaling;
import whiteboard.util.draw.SimpleConnection;
import whiteboard.util.draw.DrawingContext.FontType;
import whiteboard.util.model.ElementType;
import whiteboard.util.model.Relation;
import whiteboard.util.model.RelationEndType;
import whiteboard.util.model.RelationType;
import whiteboard.util.model.UmlClass;
import whiteboard.view.diagram.commands.ConvertConnectionTypeCommand;
import whiteboard.view.diagram.commands.DeleteElementCommand;
import whiteboard.view.diagram.commands.DiagramEditorNotification;
import whiteboard.view.diagram.commands.EditConnectionPointsCommand;
import whiteboard.view.diagram.commands.MoveElementCommand;
import whiteboard.view.diagram.commands.ResetConnectionPointsCommand;
import whiteboard.view.diagram.commands.ResizeElementCommand;
import whiteboard.view.diagram.commands.SetConnectionNavigabilityCommand;
import whiteboard.view.diagram.commands.SetLabelTextCommand;
import util.Command;
...
DiagramEditorNotification, DiagramOperations, NodeChangeListener {
  ...
  public void setDiagrm(StructureDiagram diagram1) { diagram = diagram1; }
