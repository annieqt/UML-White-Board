...
import whiteboard.util.draw.MultiSelection;
import whiteboard.util.draw.NullElement;
import whiteboard.util.draw.NullSelection;
import whiteboard.util.draw.RubberbandSelector;
