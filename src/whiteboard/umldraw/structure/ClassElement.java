...
import whiteboard.umldraw.shared.UmlModelElementLabelSource;
import whiteboard.umldraw.shared.UmlNode;
import whiteboard.util.draw.AbstractCompositeNode;
import whiteboard.util.draw.Compartment;
import whiteboard.util.draw.DoubleDimension;
...
import whiteboard.util.draw.Compartment.Alignment;
...
import whiteboard.util.model.UmlModelElementListener;
import whiteboard.util.model.UmlProperty;
import whiteboard.util.model.UmlStereotype;
...
implements LabelSource, UmlNode, UmlModelElementListener {
   ...
   */
  public static ClassElement getPrototype() { return prototype; }
