...
import whiteboard.umldraw.shared.ActorElement;
import whiteboard.umldraw.shared.NoteConnection;
import whiteboard.umldraw.shared.NoteElement;
import whiteboard.umldraw.shared.RectangleElement;
import whiteboard.umldraw.shared.UmlConnection;
import whiteboard.umldraw.shared.UmlDiagramElement;
import whiteboard.umldraw.shared.UmlNode;
import whiteboard.umldraw.shared.UsercaseElement;
import whiteboard.umldraw.structure.Association.AssociationType;
import whiteboard.util.draw.LineConnectMethod;
...
import whiteboard.util.model.UmlComponent;
import whiteboard.util.model.UmlPackage;
import whiteboard.util.model.UmlRelation;
...
public class DiagramElementFactoryImpl implements DiagramElementFactory {
  ...
  private void setupElementPrototypeMap() {
    ...
    //Add rectangle prototype
    RectangleElement rectanglePrototype = (RectangleElement)
        RectangleElement.getPrototype().clone();
    elementPrototypes.put(ElementType.RECTANGLE, rectanglePrototype);
    
  //Add user case prototype
    UsercaseElement usercasePrototype = (UsercaseElement)
        UsercaseElement.getPrototype().clone();
    elementPrototypes.put(ElementType.USERCASE, usercasePrototype);
    
    //add actor prototype
    ActorElement actorPrototype = (ActorElement)
    ActorElement.getPrototype().clone();
