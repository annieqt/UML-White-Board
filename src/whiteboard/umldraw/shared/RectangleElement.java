 ...
 * @version 1.0
 */
public final class RectangleElement extends AbstractCompositeNode
implements UmlNode, LabelSource {
  ...
  private static RectangleElement prototype = new RectangleElement();

  /**
   * Returns the prototype instance.
   * @return the prototype instance
   */
  public static RectangleElement getPrototype() { return prototype; }
  ...
  public void draw(DrawingContext drawingContext) {
    ...
    drawingContext.drawRectangle(x, y, width, height, null);
