 ...
 * @version 1.0
 */
public final class UsercaseElement extends AbstractCompositeNode
implements UmlNode, LabelSource {
  ...
  private static UsercaseElement prototype = new UsercaseElement();

  /**
   * Returns the prototype instance.
   * @return the prototype instance
   */
  public static UsercaseElement getPrototype() { return prototype; }

  /**
   * Constructor.
   */
  private UsercaseElement() {
    setSize(180, 60);
    setLabelText("");
  ...
  @Override
  public Object clone() {
	UsercaseElement cloned = (UsercaseElement) super.clone();
  ...
  public void draw(DrawingContext drawingContext) {
    ...
    drawingContext.drawOral(x, y, width, height, null, null);
    label.drawText(drawingContext, 0.4*height);
  }
