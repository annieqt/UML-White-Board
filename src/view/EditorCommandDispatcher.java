...
import view.client.ClientMainView;
...
public class EditorCommandDispatcher implements AppCommandListener {
  ...
  public EditorCommandDispatcher(ClientMainView aFrame) {
	    this.frame = aFrame;
	    initSelectorMap();
	  }
  /**
  ...
  private void initSelectorMap() {
    try {
      ...
      selectorMap.put("CREATE_NOTE", new MethodCall(
        DiagramEditor.class.getMethod("setCreationMode", ElementType.class),
          ElementType.NOTE));
      selectorMap.put("CREATE_RECTANGLE", new MethodCall(
    	        DiagramEditor.class.getMethod("setCreationMode", ElementType.class),
    	          ElementType.RECTANGLE));
      selectorMap.put("CREATE_ACTOR", new MethodCall(
  	        DiagramEditor.class.getMethod("setCreationMode", ElementType.class),
  	          ElementType.ACTOR));
      selectorMap.put("CREATE_USERCASE", new MethodCall(
    	        DiagramEditor.class.getMethod("setCreationMode", ElementType.class),
    	          ElementType.USERCASE));
